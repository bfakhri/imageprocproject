...
int main(int argc, char * argv[]) {
	...
	if(argc == 1){
		...
		imwrite("../Output/teddy/img6-img2_all_sift_matches.jpg", draw_sift_matches); 
		imwrite("../Output/teddy/img6-img2_best_sift_matches.jpg", draw_best_sift_matches); 
	}
	// Load a specific set of images
	else if(strcmp(argv[1], "-teddy") == 0){
		cout <<  "Saving Teddy Images" << endl ;
		...
		imwrite("../Output/cones/img6-img2_all_sift_matches.jpg", draw_sift_matches); 
		imwrite("../Output/cones/img6-img2_best_sift_matches.jpg", draw_best_sift_matches); 
	}
