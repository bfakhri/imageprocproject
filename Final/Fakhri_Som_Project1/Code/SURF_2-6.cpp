...
int main(int argc, char * argv[]) {
	...
	if(argc == 1){
		...
		imwrite("../Output/teddy/img2-img6_all_surf_matches.jpg", draw_surf_matches); 
		imwrite("../Output/teddy/img2-img6_best_surf_matches.jpg", draw_best_surf_matches); 
	}
	// Load a specific set of images
	else if(strcmp(argv[1], "-teddy") == 0){
		cout <<  "Saving Teddy Images" << endl ;
		...
		imwrite("../Output/cones/img2-img6_all_surf_matches.jpg", draw_surf_matches); 
		imwrite("../Output/cones/img2-img6_best_surf_matches.jpg", draw_best_surf_matches); 
	}
